...
public interface SwaggerConstants {
	...
	public static final String CLIENT_APPLICATION_UPDATE = "Please find JSON samples for client application in <a href=\"../jsp/template/json.jsp\" target=\"_blank\">templates</a>. " +
			"Please create your JSON update request using selected fields you are going to update.";
	
	public static final String CLIENT_APPLICATION_MIGRATE = "Please find JSON samples for client application in <a href=\"../jsp/template/json.jsp\" target=\"_blank\">templates</a>. " +
			"Please create your JSON update request using selected fields you are going to update.";
}
